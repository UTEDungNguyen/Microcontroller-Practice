...
z	equ	0
pclath	equ	10
# 8 "D:\TTVXL\Project TTVXL\BT01week15ttvxl\BT01week15ttvxl.c"
...
;;                           _lcd_init
;; ---------------------------------------------------------------------------------
;; (1) _lcd_init                                             4     4      0     165
;;                                              7 COMMON     3     3      0
;;                       _lcd_put_byte
;;                           _lcd_busy
;; ---------------------------------------------------------------------------------
;; (2) _lcd_busy                                             2     2      0      15
;;                                              2 COMMON     2     2      0
;; ---------------------------------------------------------------------------------
;; (2) _lcd_put_byte                                         5     4      1     150
;;                                              2 COMMON     5     4      1
;; ---------------------------------------------------------------------------------
...
;; *************** function _main *****************
;; Defined at:
;;		line 18 in file "D:\TTVXL\Project TTVXL\BT01week15ttvxl\BT01week15ttvxl.c"
...
;;
psect	maintext
	file	"D:\TTVXL\Project TTVXL\BT01week15ttvxl\BT01week15ttvxl.c"
	line	18
...
l3619:	
;BT01week15ttvxl.c: 19: ANSEL = ANSELH = 0;
...
l3621:	
;BT01week15ttvxl.c: 20: lcd_init();
	fcall	_lcd_init
	line	21
	
l3623:	
;BT01week15ttvxl.c: 21: TRISE0 = 0; RE0 = 1;
...
l3627:	
;BT01week15ttvxl.c: 23: T2CKPS1 = 0; T2CKPS0 = 1;
	bcf	(145/8),(145)&7
...
l3631:	
;BT01week15ttvxl.c: 24: TMR2 = 0;PR2 = 124;
	clrf	(17)	;volatile
...
l3635:	
;BT01week15ttvxl.c: 25: TOUTPS3 = 0;TOUTPS2 = 0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	(150/8),(150)&7
...
l3639:	
;BT01week15ttvxl.c: 26: TOUTPS1 = 0;TOUTPS0 = 0;
	bcf	(148/8),(148)&7
...
l3643:	
;BT01week15ttvxl.c: 27: TMR2ON = 1;
	bsf	(146/8),(146)&7
	line	28
	
l3645:	
;BT01week15ttvxl.c: 28: TMR2IE = 1; TMR2IF = 0; PEIE = 1; GIE =1;
	bsf	status, 5	;RP0=1, select bank1
...
;; *************** function _ngat *****************
;; Defined at:
;;		line 34 in file "D:\TTVXL\Project TTVXL\BT01week15ttvxl\BT01week15ttvxl.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
i1l3515:	
;BT01week15ttvxl.c: 35: if(TMR2IF)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	btfss	(97/8),(97)&7
	goto	u1_21
...
i1l3519:	
;BT01week15ttvxl.c: 37: if (dem == 250){RE0 = 0;}
		movf	(_dem),w
	xorlw	250
	iorwf	(_dem+1),w
...
i1l3523:	
;BT01week15ttvxl.c: 38: if (dem == 500){dem = 0;RE0 = 1;}
	decf	(_dem+1),w
	movlw	244
	skipnz
	xorwf	(_dem),w
...
i1l3529:	
;BT01week15ttvxl.c: 39: }
;BT01week15ttvxl.c: 40: TMR2IF = 0;
	bcf	(97/8),(97)&7
	line	41

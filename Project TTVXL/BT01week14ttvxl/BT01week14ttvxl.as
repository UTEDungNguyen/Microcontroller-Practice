...
z	equ	0
pclath	equ	10
# 8 "D:\TTVXL\Project TTVXL\BT01week14ttvxl\BT01week14ttvxl.c"
...
lcd_put_byte@b:	; 1 bytes @ 0x2
	global	_isdigit$3681
_isdigit$3681:	; 1 bytes @ 0x2
	global	_isprint$3684
_isprint$3684:	; 1 bytes @ 0x2
...
___ftsub@f1:	; 3 bytes @ 0x33
	global	_fround$4121
_fround$4121:	; 3 bytes @ 0x33
	ds	3
	global	_fround$4120
_fround$4120:	; 3 bytes @ 0x36
	ds	3
	global	fround@prec
...
?_printf:	; 2 bytes @ 0x3A
	ds	4
	global	??_printf
??_printf:	; 0 bytes @ 0x3E
	ds	5
;;Data sizes: Strings 20, constant 118, data 0, bss 11, persistent 0 stack 0
...
;; *************** function _main *****************
;; Defined at:
;;		line 22 in file "D:\TTVXL\Project TTVXL\BT01week14ttvxl\BT01week14ttvxl.c"
...
;;
psect	maintext
	file	"D:\TTVXL\Project TTVXL\BT01week14ttvxl\BT01week14ttvxl.c"
	line	22
...
l8435:	
;BT01week14ttvxl.c: 23: ANSEL = ANSELH = 0;
...
l8437:	
;BT01week14ttvxl.c: 24: lcd_init();
	fcall	_lcd_init
	line	25
	
l8439:	
;BT01week14ttvxl.c: 25: TRISE0 = 0; RE0 = 1;
...
l8443:	
;BT01week14ttvxl.c: 26: TRISC2=0;
	bsf	status, 5	;RP0=1, select bank1
	bcf	(1082/8)^080h,(1082)&7
	line	29
	
l8445:	
;BT01week14ttvxl.c: 29: T2CKPS1 = 0; T2CKPS0 = 1;
	bcf	status, 5	;RP0=0, select bank0
	bcf	(145/8),(145)&7
...
l8449:	
;BT01week14ttvxl.c: 30: PR2 = 124; TMR2 = 0;
	movlw	(07Ch)
	bsf	status, 5	;RP0=1, select bank1
...
l8453:	
;BT01week14ttvxl.c: 31: TMR2ON = 1;
	bsf	(146/8),(146)&7
	line	34
	
l8455:	
;BT01week14ttvxl.c: 34: CCP1CON=0b00001100;
	movlw	(0Ch)
	movwf	(23)	;volatile
	line	37
	
l8457:	
;BT01week14ttvxl.c: 37: TMR1CS =1 ;
	bsf	(129/8),(129)&7
	line	38
	
l8459:	
;BT01week14ttvxl.c: 38: T1CKPS1=0; T1CKPS0=0;
	bcf	(133/8),(133)&7
...
l8463:	
;BT01week14ttvxl.c: 39: T1SYNC =1;
	bsf	(130/8),(130)&7
	line	40
	
l8465:	
;BT01week14ttvxl.c: 40: TMR1=0;
	clrf	(14)	;volatile
	clrf	(14+1)	;volatile
	line	41
	
l8467:	
;BT01week14ttvxl.c: 41: TMR1GE=0;
	bcf	(134/8),(134)&7
	line	42
	
l8469:	
;BT01week14ttvxl.c: 42: TMR1ON=1;
	bsf	(128/8),(128)&7
	line	44
	
l8471:	
;BT01week14ttvxl.c: 44: T0CS = 0;
	bsf	status, 5	;RP0=1, select bank1
	bcf	(1037/8)^080h,(1037)&7
	line	45
	
l8473:	
;BT01week14ttvxl.c: 45: PSA =0;
	bcf	(1035/8)^080h,(1035)&7
	line	46
	
l8475:	
;BT01week14ttvxl.c: 46: PS2=0;PS1=1;PS0=0;
...
l8483:	
;BT01week14ttvxl.c: 48: T0IE=1;
	bsf	(93/8),(93)&7
	line	49
	
l8485:	
;BT01week14ttvxl.c: 49: T0IF=0;
	bcf	(90/8),(90)&7
	line	50
	
l8487:	
;BT01week14ttvxl.c: 50: GIE=1;
	bsf	(95/8),(95)&7
	line	51
	
l8489:	
;BT01week14ttvxl.c: 51: PEIE=1;
	bsf	(94/8),(94)&7
	line	53
	
l8491:	
;BT01week14ttvxl.c: 53: pwm_t = 300;
	movlw	low(012Ch)
	movwf	(_pwm_t)
	movlw	high(012Ch)
	movwf	((_pwm_t))+1
...
l8493:	
;BT01week14ttvxl.c: 54: pwm_10bit(pwm_t);
	movlw	low(012Ch)
	movwf	(?_pwm_10bit)
	movlw	high(012Ch)
	movwf	((?_pwm_10bit))+1
...
l8495:	
;BT01week14ttvxl.c: 57: {
;BT01week14ttvxl.c: 58: v = (xung/360.0)*10.0*60.0;
	movlw	0x0
	bcf	status, 5	;RP0=0, select bank0
	movwf	(?___ftmul)
	movlw	0x16
...
l8497:	
;BT01week14ttvxl.c: 59: if(v < 30.7)pwm_t = pwm_t++;
	movf	(_v),w
	movwf	(?___ftge)
	movf	(_v+1),w
	movwf	(?___ftge+1)
...
l8501:	
;BT01week14ttvxl.c: 60: else if(v > 30.7)pwm_t = pwm_t--;
	movlw	0x9a
	movwf	(?___ftge)
	movlw	0xf5
	movwf	(?___ftge+1)
...
l8505:	
;BT01week14ttvxl.c: 62: pwm_10bit(pwm_t);
	movf	(_pwm_t+1),w
	movwf	(?_pwm_10bit+1)
	movf	(_pwm_t),w
	movwf	(?_pwm_10bit)
...
l8507:	
;BT01week14ttvxl.c: 63: lcd_gotoxy(0,0);
	clrf	(?_lcd_gotoxy)
	movlw	(0)
	fcall	_lcd_gotoxy
	line	64
...
l8509:	
;BT01week14ttvxl.c: 64: printf("v: %3.2f",v);
	movf	(_v),w
	movwf	(?_printf)
	movf	(_v+1),w
	movwf	(?_printf+1)
...
l8511:	
;BT01week14ttvxl.c: 65: lcd_gotoxy(0,1);
	clrf	(?_lcd_gotoxy)
	incf	(?_lcd_gotoxy),f
	movlw	(0)
	fcall	_lcd_gotoxy
...
l8513:	
;BT01week14ttvxl.c: 66: printf("xung: %05d",xung);
	movf	(_xung+3),w
	movwf	(?_printf+3)
	movf	(_xung+2),w
	movwf	(?_printf+2)
...
l8267:	
	...
	bsf	status, 5	;RP0=1, select bank1
	movwf	(_printf$3173+3)^080h
	movf	(2+(?__tdiv_to_l_)),w
	movwf	(_printf$3173+2)^080h
	movf	(1+(?__tdiv_to_l_)),w
	movwf	(_printf$3173+1)^080h
	movf	(0+(?__tdiv_to_l_)),w
	movwf	(_printf$3173)^080h

	
l8269:	
	movf	(_printf$3173+3)^080h,w
	movwf	(printf@_val+3)^080h
	movf	(_printf$3173+2)^080h,w
	movwf	(printf@_val+2)^080h
	movf	(_printf$3173+1)^080h,w
	movwf	(printf@_val+1)^080h
	movf	(_printf$3173)^080h,w
...
;; *************** function _putch *****************
;; Defined at:
;;		line 95 in file "D:\TTVXL\Project TTVXL\BT01week14ttvxl\BT01week14ttvxl.c"
;; Parameters:    Size  Location     Type
...
l8149:	
;BT01week14ttvxl.c: 96: lcd_putc(c);
	movf	(putch@c),w
	fcall	_lcd_putc
	line	97
...
l8091:	
	...
	movf	(_scale$4122),w
	movwf	0+(?___ftmul)+03h
	movf	(_scale$4122+1),w
	movwf	1+(?___ftmul)+03h
	movf	(_scale$4122+2),w
	movwf	2+(?___ftmul)+03h
	fcall	___ftmul
	movf	(0+(?___ftmul)),w
	movwf	(?_scale)
...
l8065:	
	...
	movwf	(_fround$4120)
	movf	(1+(?___ftmul)),w
	movwf	(_fround$4120+1)
	movf	(2+(?___ftmul)),w
	movwf	(_fround$4120+2)
	movlw	(03h)
	movwf	(?___bmul)
	movlw	(0Ah)
	movwf	(?___lbmod)
	...
	movf	(_fround$4120),w
	movwf	0+(?___ftmul)+03h
	movf	(_fround$4120+1),w
	movwf	1+(?___ftmul)+03h
	movf	(_fround$4120+2),w
	movwf	2+(?___ftmul)+03h
	fcall	___ftmul
	movf	(0+(?___ftmul)),w
	movwf	(_fround$4121)
	movf	(1+(?___ftmul)),w
	movwf	(_fround$4121+1)
	movf	(2+(?___ftmul)),w
	movwf	(_fround$4121+2)
...
l8067:	
	...
	movf	(_fround$4121),w
	movwf	0+(?___ftmul)+03h
	movf	(_fround$4121+1),w
	movwf	1+(?___ftmul)+03h
	movf	(_fround$4121+2),w
	movwf	2+(?___ftmul)+03h
	fcall	___ftmul
	movf	(0+(?___ftmul)),w
	movwf	(?_fround)
...
;; *************** function _pwm_10bit *****************
;; Defined at:
;;		line 87 in file "D:\TTVXL\Project TTVXL\BT01week14ttvxl\BT01week14ttvxl.c"
;; Parameters:    Size  Location     Type
;;  pwm             2    8[BANK0 ] int 
;; Auto vars:     Size  Location     Type
;;		None
...
l7747:	
;BT01week14ttvxl.c: 88: CCPR1L=pwm/4;
	movlw	04h
	movwf	(?___awdiv)
	clrf	(?___awdiv+1)
...
l7749:	
;BT01week14ttvxl.c: 89: DC1B1=0;DC1B0=0;
	bcf	(189/8),(189)&7
...
l7753:	
;BT01week14ttvxl.c: 90: if ((pwm & 2)==1) DC1B1=1;
	movf	(pwm_10bit@pwm),w
	andlw	02h
	xorlw	01h
	skipz
...
l1071:	
	line	91
;BT01week14ttvxl.c: 91: if ((pwm & 1)==1) DC1B0=1;
...
;; *************** function _ngat *****************
;; Defined at:
;;		line 71 in file "D:\TTVXL\Project TTVXL\BT01week14ttvxl\BT01week14ttvxl.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
i1l6237:	
;BT01week14ttvxl.c: 74: {
;BT01week14ttvxl.c: 75: TMR0 = 6;
	movlw	(06h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(1)	;volatile
...
i1l6241:	
;BT01week14ttvxl.c: 77: if(dem == 250){
		movf	(_dem),w
	xorlw	250
	iorwf	(_dem+1),w
...
i1l6243:	
;BT01week14ttvxl.c: 78: dem= 0;
	clrf	(_dem)
	clrf	(_dem+1)
	line	79
	
i1l6245:	
;BT01week14ttvxl.c: 79: xung = TMR1;
	movf	(14),w	;volatile
	movwf	(_xung)
...
i1l6247:	
;BT01week14ttvxl.c: 80: TMR1 = 0;
	clrf	(14)	;volatile
	clrf	(14+1)	;volatile
	line	81
	
i1l6249:	
;BT01week14ttvxl.c: 81: TMR1H=0; TMR1L=0;
	clrf	(15)	;volatile
...
i1l6253:	
;BT01week14ttvxl.c: 82: }
;BT01week14ttvxl.c: 83: }
;BT01week14ttvxl.c: 84: T0IF = 0;
	bcf	(90/8),(90)&7
	line	85

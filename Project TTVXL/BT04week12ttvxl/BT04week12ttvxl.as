...
z	equ	0
pclath	equ	10
# 7 "D:\TTVXL\Project TTVXL\BT04week12ttvxl\BT04week12ttvxl.c"
...
lcd_put_byte@b:	; 1 bytes @ 0x0
	global	_isdigit$3683
_isdigit$3683:	; 1 bytes @ 0x0
	global	_isprint$3686
_isprint$3686:	; 1 bytes @ 0x0
...
___ftsub@f1:	; 3 bytes @ 0x39
	global	_fround$4120
_fround$4120:	; 3 bytes @ 0x39
	ds	3
	global	_fround$4119
_fround$4119:	; 3 bytes @ 0x3C
	ds	3
	global	fround@prec
...
;; *************** function _main *****************
;; Defined at:
;;		line 19 in file "D:\TTVXL\Project TTVXL\BT04week12ttvxl\BT04week12ttvxl.c"
...
;;
psect	maintext
	file	"D:\TTVXL\Project TTVXL\BT04week12ttvxl\BT04week12ttvxl.c"
	line	19
...
l8048:	
;BT04week12ttvxl.c: 20: ANSEL = ANSELH = 0;
...
l8050:	
;BT04week12ttvxl.c: 21: lcd_init();
	fcall	_lcd_init
	line	22
	
l8052:	
;BT04week12ttvxl.c: 22: TRISA4 = 1;
	bsf	status, 5	;RP0=1, select bank1
	bsf	(1068/8)^080h,(1068)&7
	line	23
	
l8054:	
;BT04week12ttvxl.c: 23: TRISD = 0x00;
	clrf	(136)^080h	;volatile
	line	24
	
l8056:	
;BT04week12ttvxl.c: 24: TRISE0 = 0;
	bcf	(1096/8)^080h,(1096)&7
	line	27
	
l8058:	
;BT04week12ttvxl.c: 27: TMR1GE=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	(134/8),(134)&7
	line	28
	
l8060:	
;BT04week12ttvxl.c: 28: TMR1CS=0;
	bcf	(129/8),(129)&7
	line	29
	
l8062:	
;BT04week12ttvxl.c: 29: T1SYNC=1;
	bsf	(130/8),(130)&7
	line	30
	
l8064:	
;BT04week12ttvxl.c: 30: T1CKPS1=0;T1CKPS0=0;
	bcf	(133/8),(133)&7
...
l8068:	
;BT04week12ttvxl.c: 31: TMR1ON=1;
	bsf	(128/8),(128)&7
	line	32
	
l8070:	
;BT04week12ttvxl.c: 32: TMR1H=0;
	clrf	(15)	;volatile
	line	33
	
l8072:	
;BT04week12ttvxl.c: 33: TMR1L=0;
	clrf	(14)	;volatile
	line	36
	
l8074:	
;BT04week12ttvxl.c: 36: TRISC2 =1;
	bsf	status, 5	;RP0=1, select bank1
	bsf	(1082/8)^080h,(1082)&7
	line	38
	
l8076:	
;BT04week12ttvxl.c: 38: CCP1CON = 0b00000110;
	movlw	(06h)
	bcf	status, 5	;RP0=0, select bank0
	movwf	(23)	;volatile
	line	39
...
l8078:	
;BT04week12ttvxl.c: 39: CCP1IE=1;
	bsf	status, 5	;RP0=1, select bank1
	bsf	(1122/8)^080h,(1122)&7
	line	40
	
l8080:	
;BT04week12ttvxl.c: 40: CCP1IF=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	(98/8),(98)&7
	line	41
	
l8082:	
;BT04week12ttvxl.c: 41: PEIE=1;
	bsf	(94/8),(94)&7
	line	42
	
l8084:	
;BT04week12ttvxl.c: 42: GIE=1;
	bsf	(95/8),(95)&7
	line	47
	
l8086:	
;BT04week12ttvxl.c: 45: {
;BT04week12ttvxl.c: 47: t = xung*(1.0/5000000.0);
	movlw	0xc0
	bcf	status, 5	;RP0=0, select bank0
	movwf	(?___ftmul)
	movlw	0x56
...
l8090:	
;BT04week12ttvxl.c: 49: lcd_gotoxy(0,0);
	clrf	(?_lcd_gotoxy)
	movlw	(0)
	fcall	_lcd_gotoxy
	line	50
...
l8092:	
;BT04week12ttvxl.c: 50: printf("xung: %08u",xung);
	movf	(_xung+3),w
	movwf	(?_printf+3)
	movf	(_xung+2),w
	movwf	(?_printf+2)
...
l8094:	
;BT04week12ttvxl.c: 51: lcd_gotoxy(0,1);
	bcf	status, 5	;RP0=0, select bank0
	clrf	(?_lcd_gotoxy)
	incf	(?_lcd_gotoxy),f
	movlw	(0)
...
l8096:	
;BT04week12ttvxl.c: 52: printf("f: %5.2f",f);
	movf	(_f),w
	movwf	(?_printf)
	movf	(_f+1),w
	movwf	(?_printf+1)
...
;; *************** function _putch *****************
;; Defined at:
;;		line 64 in file "D:\TTVXL\Project TTVXL\BT04week12ttvxl\BT04week12ttvxl.c"
;; Parameters:    Size  Location     Type
...
l7766:	
;BT04week12ttvxl.c: 65: lcd_putc(c);
	movf	(putch@c),w
	fcall	_lcd_putc
	line	66
...
l7708:	
	...
	movf	(_scale$4121),w
	movwf	0+(?___ftmul)+03h
	movf	(_scale$4121+1),w
	movwf	1+(?___ftmul)+03h
	movf	(_scale$4121+2),w
	movwf	2+(?___ftmul)+03h
	fcall	___ftmul
	movf	(0+(?___ftmul)),w
	movwf	(?_scale)
...
;; *************** function _ngat *****************
;; Defined at:
;;		line 68 in file "D:\TTVXL\Project TTVXL\BT04week12ttvxl\BT04week12ttvxl.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
i1l6126:	
;BT04week12ttvxl.c: 69: if(CCP1IF)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	btfss	(98/8),(98)&7
	goto	u201_21
...
i1l6128:	
;BT04week12ttvxl.c: 70: {
;BT04week12ttvxl.c: 71: xung = abs(CCPR1-count_old);
...
i1l6130:	
;BT04week12ttvxl.c: 72: count_old = CCPR1;
	movf	(21+1),w	;volatile
	movwf	(_count_old+1)	;volatile
	movf	(21),w	;volatile
	movwf	(_count_old)	;volatile
	line	74
	
i1l6132:	
;BT04week12ttvxl.c: 73: }
;BT04week12ttvxl.c: 74: CCP1IF = 0;
	bcf	(98/8),(98)&7
	line	75

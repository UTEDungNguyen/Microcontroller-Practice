...
z	equ	0
pclath	equ	10
# 7 "D:\TTVXL\Project TTVXL\BT Ôn Thi 01\BT Ôn Thi 01.c"
...
;; *************** function _main *****************
;; Defined at:
;;		line 19 in file "D:\TTVXL\Project TTVXL\BT Ôn Thi 01\BT Ôn Thi 01.c"
...
;;
psect	maintext
	file	"D:\TTVXL\Project TTVXL\BT Ôn Thi 01\BT Ôn Thi 01.c"
	line	19
...
l3523:	
;BT Ôn Thi 01.c: 20: ANSEL = ANSELH = 0;
...
l3525:	
;BT Ôn Thi 01.c: 21: TRISE0 = 0; RE0 = 1;
...
l3529:	
;BT Ôn Thi 01.c: 24: T2CKPS1 = 0; T2CKPS0 = 0;
	bcf	(145/8),(145)&7
	
l3531:	
	bcf	(144/8),(144)&7
	line	25
;BT Ôn Thi 01.c: 25: TMR2 = 0;PR2 = 49;
	clrf	(17)	;volatile
...
l3535:	
;BT Ôn Thi 01.c: 26: TOUTPS3 = 0;TOUTPS2 = 0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	(150/8),(150)&7
...
l3539:	
;BT Ôn Thi 01.c: 27: TOUTPS1 = 0;TOUTPS0 = 0;
	bcf	(148/8),(148)&7
...
l3543:	
;BT Ôn Thi 01.c: 28: TMR2ON = 1;
	bsf	(146/8),(146)&7
	line	29
	
l3545:	
;BT Ôn Thi 01.c: 29: TMR2IE = 1; TMR2IF = 0; PEIE = 1; GIE =1;
	bsf	status, 5	;RP0=1, select bank1
...
l3553:	
;BT Ôn Thi 01.c: 32: tx();
	fcall	_tx
	line	33
	
l3555:	
;BT Ôn Thi 01.c: 33: rx();
	fcall	_rx
	line	40
	
l3557:	
;BT Ôn Thi 01.c: 38: {
;BT Ôn Thi 01.c: 40: for (int b=0;b<=2;b++){
	clrf	(main@b)
	clrf	(main@b+1)
	line	41
	
l3563:	
;BT Ôn Thi 01.c: 41: gocquay_start[b]=data_rx[b];
	bcf	status, 5	;RP0=0, select bank0
...
l3569:	
;BT Ôn Thi 01.c: 42: }
;BT Ôn Thi 01.c: 43: angle=atoi(gocquay_start);
...
l3571:	
;BT Ôn Thi 01.c: 44: if (angle <= 179){angle++;}
	movf	(_angle+1),w
	xorlw	80h
	movwf	btemp+1
	movlw	(high(0B4h))^80h
...
l3575:	
;BT Ôn Thi 01.c: 45: gocquay(angle);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_angle+1),w
	movwf	(?_gocquay+1)
...
;; *************** function _gocquay *****************
;; Defined at:
;;		line 67 in file "D:\TTVXL\Project TTVXL\BT Ôn Thi 01\BT Ôn Thi 01.c"
;; Parameters:    Size  Location     Type
;;  goc             2   46[BANK0 ] int 
;; Auto vars:     Size  Location     Type
;;		None
...
l3521:	
;BT Ôn Thi 01.c: 68: A = 100 + goc*(1/1.8);
...
;; *************** function _rx *****************
;; Defined at:
;;		line 86 in file "D:\TTVXL\Project TTVXL\BT Ôn Thi 01\BT Ôn Thi 01.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l2927:	
;BT Ôn Thi 01.c: 87: SYNC = 0; BRGH = 1; BRG16 = 1;
	bsf	status, 5	;RP0=1, select bank1
...
l2929:	
;BT Ôn Thi 01.c: 88: SPBRGH = 0x02;
	movlw	(02h)
	bcf	status, 6	;RP1=0, select bank1
	movwf	(154)^080h	;volatile
	line	89
;BT Ôn Thi 01.c: 89: SPBRG = 0x08;
	movlw	(08h)
	movwf	(153)^080h	;volatile
	line	90
	
l2931:	
;BT Ôn Thi 01.c: 90: CREN = 1; RX9 = 0; SPEN = 1;
	bcf	status, 5	;RP0=0, select bank0
	bsf	(196/8),(196)&7
...
l2937:	
;BT Ôn Thi 01.c: 91: RCIE=1; RCIF=0; PEIE=1; GIE=1;
	bsf	status, 5	;RP0=1, select bank1
...
;; *************** function _tx *****************
;; Defined at:
;;		line 79 in file "D:\TTVXL\Project TTVXL\BT Ôn Thi 01\BT Ôn Thi 01.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l2917:	
;BT Ôn Thi 01.c: 80: SYNC = 0; BRGH = 1; BRG16 = 1;
	bsf	status, 5	;RP0=1, select bank1
	bcf	(1220/8)^080h,(1220)&7
	bsf	(1218/8)^080h,(1218)&7
	bsf	status, 6	;RP1=1, select bank3
...
l2919:	
;BT Ôn Thi 01.c: 81: SPBRGH = 0x02;
	movlw	(02h)
	bcf	status, 6	;RP1=0, select bank1
	movwf	(154)^080h	;volatile
	line	82
;BT Ôn Thi 01.c: 82: SPBRG = 0x08;
	movlw	(08h)
	movwf	(153)^080h	;volatile
	line	83
	
l2921:	
;BT Ôn Thi 01.c: 83: TXEN = 1; TX9 = 0; SPEN = 1;
...
;; *************** function _ngat *****************
;; Defined at:
;;		line 50 in file "D:\TTVXL\Project TTVXL\BT Ôn Thi 01\BT Ôn Thi 01.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
i1l2949:	
;BT Ôn Thi 01.c: 53: if (dem == A){RE0 = 0;}
	movf	(_A+1),w
	xorwf	(_dem+1),w
	skipz
	goto	u63_25
...
i1l2953:	
;BT Ôn Thi 01.c: 54: if (dem == 2000){dem = 0;RE0 = 1;}
		movf	(_dem+1),w
	xorlw	7
	movlw	208
	skipnz
...
i1l2959:	
;BT Ôn Thi 01.c: 55: }
;BT Ôn Thi 01.c: 56: TMR2IF = 0;
	bcf	(97/8),(97)&7
	line	58
	
i1l2961:	
;BT Ôn Thi 01.c: 58: if (RCIF){
	btfss	(101/8),(101)&7
	goto	u65_21
	goto	u65_20
u65_21:
...
i1l2963:	
;BT Ôn Thi 01.c: 59: data_rx[a]=RCREG;
	movf	(_a),w
	addlw	_data_rx&0ffh
	movwf	fsr0
	movf	(26),w	;volatile

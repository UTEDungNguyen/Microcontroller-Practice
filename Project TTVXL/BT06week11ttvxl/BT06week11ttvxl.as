...
z	equ	0
pclath	equ	10
# 7 "D:\TTVXL\Project TTVXL\BT06week11ttvxl\BT06week11ttvxl.c"
...
___ftsub@f1:	; 3 bytes @ 0x2F
	global	_fround$4122
_fround$4122:	; 3 bytes @ 0x2F
	ds	3
	global	_fround$4121
_fround$4121:	; 3 bytes @ 0x32
	ds	3
	global	fround@prec
...
;; *************** function _main *****************
;; Defined at:
;;		line 19 in file "D:\TTVXL\Project TTVXL\BT06week11ttvxl\BT06week11ttvxl.c"
...
;;
psect	maintext
	file	"D:\TTVXL\Project TTVXL\BT06week11ttvxl\BT06week11ttvxl.c"
	line	19
...
l7161:	
;BT06week11ttvxl.c: 20: ANSEL = ANSELH = 0;
...
l7163:	
;BT06week11ttvxl.c: 21: lcd_init();
	fcall	_lcd_init
	line	22
	
l7165:	
;BT06week11ttvxl.c: 22: TRISA4 = 1;
	bsf	status, 5	;RP0=1, select bank1
	bsf	(1068/8)^080h,(1068)&7
	line	23
	
l7167:	
;BT06week11ttvxl.c: 23: TRISD = 0x00;
	clrf	(136)^080h	;volatile
	line	24
	
l7169:	
;BT06week11ttvxl.c: 24: TRISE0 = 0;
	bcf	(1096/8)^080h,(1096)&7
	line	25
	
l7171:	
;BT06week11ttvxl.c: 25: TRISE1 = 0;
	bcf	(1097/8)^080h,(1097)&7
	line	26
	
l7173:	
;BT06week11ttvxl.c: 26: RE1 =0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	(73/8),(73)&7
	line	29
	
l7175:	
;BT06week11ttvxl.c: 29: TMR1GE=0;
	bcf	(134/8),(134)&7
	line	30
	
l7177:	
;BT06week11ttvxl.c: 30: TMR1CS=0;
	bcf	(129/8),(129)&7
	line	31
	
l7179:	
;BT06week11ttvxl.c: 31: T1SYNC=1;
	bsf	(130/8),(130)&7
	line	32
	
l7181:	
;BT06week11ttvxl.c: 32: T1CKPS1=0;T1CKPS0=0;
	bcf	(133/8),(133)&7
...
l7185:	
;BT06week11ttvxl.c: 34: TMR1H=0;
	clrf	(15)	;volatile
	line	35
	
l7187:	
;BT06week11ttvxl.c: 35: TMR1L=0;
	clrf	(14)	;volatile
	line	36
	
l7189:	
;BT06week11ttvxl.c: 36: TMR1ON=1;
	bsf	(128/8),(128)&7
	line	39
	
l7191:	
;BT06week11ttvxl.c: 39: TRISC2 =1;
	bsf	status, 5	;RP0=1, select bank1
	bsf	(1082/8)^080h,(1082)&7
	line	40
	
l7193:	
;BT06week11ttvxl.c: 40: TRISC1 =1;
	bsf	(1081/8)^080h,(1081)&7
	line	41
	
l7195:	
;BT06week11ttvxl.c: 41: CCP1CON = 0b00000101;
	movlw	(05h)
	bcf	status, 5	;RP0=0, select bank0
	movwf	(23)	;volatile
	line	42
...
l7197:	
;BT06week11ttvxl.c: 42: CCP2CON = 0b00000100;
	movlw	(04h)
	movwf	(29)	;volatile
	line	43
	
l7199:	
;BT06week11ttvxl.c: 43: CCP1IE=1;
	bsf	status, 5	;RP0=1, select bank1
	bsf	(1122/8)^080h,(1122)&7
	line	44
	
l7201:	
;BT06week11ttvxl.c: 44: CCP1IF=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	(98/8),(98)&7
	line	45
	
l7203:	
;BT06week11ttvxl.c: 45: CCP2IE=1;
	bsf	status, 5	;RP0=1, select bank1
	bsf	(1128/8)^080h,(1128)&7
	line	46
	
l7205:	
;BT06week11ttvxl.c: 46: CCP2IF=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	(104/8),(104)&7
	line	47
	
l7207:	
;BT06week11ttvxl.c: 47: PEIE=1;
	bsf	(94/8),(94)&7
	line	48
	
l7209:	
;BT06week11ttvxl.c: 48: GIE=1;
	bsf	(95/8),(95)&7
	line	53
	
l7211:	
;BT06week11ttvxl.c: 51: {
;BT06week11ttvxl.c: 53: _delay((unsigned long)((100)*(20000000/4000.0)));
	opt asmopt_off
movlw  3
	bcf	status, 5	;RP0=0, select bank0
movwf	((??_main+0)+0+2),f
...
l7215:	
;BT06week11ttvxl.c: 55: _delay((unsigned long)((1)*(20000000/4000.0)));
	opt asmopt_off
movlw	7
movwf	((??_main+0)+0+1),f
	movlw	125
...
l7217:	
;BT06week11ttvxl.c: 56: RE1=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bcf	(73/8),(73)&7
	line	58
;BT06week11ttvxl.c: 58: xung = abs(count2-count1);
	movf	(_count2+1),w
	movwf	(?_abs+1)
	movf	(_count2),w
	movwf	(?_abs)
	...
	movwf	(_xung+3)
	line	59
;BT06week11ttvxl.c: 59: t = xung*(1.0/5000000.0);
	movlw	0xc0
	movwf	(?___ftmul)
	movlw	0x56
	movwf	(?___ftmul+1)
	...
	movwf	(_t+2)
	line	60
;BT06week11ttvxl.c: 60: d = 17000.0*t;
	movlw	0xd0
	movwf	(?___ftmul)
	movlw	0x84
	movwf	(?___ftmul+1)
	...
	movwf	(_d+2)
	line	61
;BT06week11ttvxl.c: 61: lcd_gotoxy(0,0);
	clrf	(?_lcd_gotoxy)
	movlw	(0)
	fcall	_lcd_gotoxy
	line	62
...
l7219:	
;BT06week11ttvxl.c: 62: printf("xung: %08u",xung);
	movf	(_xung+3),w
	movwf	(?_printf+3)
	movf	(_xung+2),w
	movwf	(?_printf+2)
...
l7221:	
;BT06week11ttvxl.c: 63: lcd_gotoxy(0,1);
	clrf	(?_lcd_gotoxy)
	incf	(?_lcd_gotoxy),f
	movlw	(0)
	fcall	_lcd_gotoxy
	line	64
;BT06week11ttvxl.c: 64: printf("f: %5.2f",d);
	movf	(_d),w
	movwf	(?_printf)
	movf	(_d+1),w
	movwf	(?_printf+1)
...
;; *************** function _putch *****************
;; Defined at:
;;		line 69 in file "D:\TTVXL\Project TTVXL\BT06week11ttvxl\BT06week11ttvxl.c"
;; Parameters:    Size  Location     Type
...
l6879:	
;BT06week11ttvxl.c: 70: lcd_putc(c);
	movf	(putch@c),w
	fcall	_lcd_putc
	line	71
...
l6821:	
	...
	movf	(_scale$4123),w
	movwf	0+(?___ftmul)+03h
	movf	(_scale$4123+1),w
	movwf	1+(?___ftmul)+03h
	movf	(_scale$4123+2),w
	movwf	2+(?___ftmul)+03h
	fcall	___ftmul
	movf	(0+(?___ftmul)),w
	movwf	(?_scale)
...
;; *************** function _ngat *****************
;; Defined at:
;;		line 73 in file "D:\TTVXL\Project TTVXL\BT06week11ttvxl\BT06week11ttvxl.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
i1l6109:	
;BT06week11ttvxl.c: 74: if(CCP1IF)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	btfss	(98/8),(98)&7
	goto	u199_21
...
i1l6111:	
;BT06week11ttvxl.c: 75: {
;BT06week11ttvxl.c: 76: count1=CCPR1;
...
i1l6113:	
;BT06week11ttvxl.c: 77: }
;BT06week11ttvxl.c: 78: if(CCP2IF)
	btfss	(104/8),(104)&7
	goto	u200_21
	goto	u200_20
u200_21:
...
i1l6115:	
;BT06week11ttvxl.c: 79: {
;BT06week11ttvxl.c: 80: count2=CCPR2;
...
i1l6117:	
;BT06week11ttvxl.c: 81: }
;BT06week11ttvxl.c: 82: CCP1IF = 0;
	bcf	(98/8),(98)&7
	line	83
	
i1l6119:	
;BT06week11ttvxl.c: 83: CCP2IF = 0;
	bcf	(104/8),(104)&7
	line	85
